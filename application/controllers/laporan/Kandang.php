...
class Kandang extends CI_Controller
{
	...
	{
		$data['menu'] = "laporan";
		$data['submenu'] = "kandang";
		$data['judul'] = "Laporan Kandang";
		$this->load->view('layout/header', $data);
		$this->load->view('laporan/kandang/table', $data);
		$this->load->view('laporan/kandang/modal', $data);
		$this->load->view('layout/footer', $data);
		$this->load->view('laporan/kandang/script', $data);
	}
	...
	public function upload_ktp()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/kandang/ktp/";
	...
	public function upload_sertifikat()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/kandang/sertifikat/";
			$targetFilePath = $targetDir . $namaFile;
