...
class Cash_flow extends CI_Controller
{
	...
	{
		$data['menu'] = "laporan";
		$data['submenu'] = "cash_flow";
		$data['judul'] = "Laporan Cash Flow";
		$this->load->view('layout/header', $data);
		$this->load->view('laporan/cash_flow/table', $data);
		$this->load->view('laporan/cash_flow/modal', $data);
		$this->load->view('layout/footer', $data);
		$this->load->view('laporan/cash_flow/script', $data);
	}

	public function get_all()
	{
		$data = $this->cash_flow_model->list_data();
	...
	function get_data()
	{
		...
		$data = $this->cash_flow_model->get_data_by_id($kode);
		echo json_encode($data);
	}
	...
	{
		$data = $_POST;
		$this->cash_flow_model->save($data);
	}

	public function delete()
	{
		$id = $this->input->post('id');
		$data = $this->cash_flow_model->delete($id);
		echo json_encode($data);
	}
	...
	public function upload_ktp()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/cash_flow/ktp/";
	...
	public function upload_sertifikat()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/cash_flow/sertifikat/";
			$targetFilePath = $targetDir . $namaFile;
