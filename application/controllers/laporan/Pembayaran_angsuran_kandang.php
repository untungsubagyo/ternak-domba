...
class Pembayaran_angsuran_kandang extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['judul'] = "Laporan Pembayaran Angsuran Kandang";
		$this->load->view('layout/header', $data);
		$this->load->view('laporan/pembayaran_angsuran_kandang/table', $data);
		$this->load->view('laporan/pembayaran_angsuran_kandang/modal', $data);
		$this->load->view('layout/footer', $data);
		$this->load->view('laporan/pembayaran_angsuran_kandang/script', $data);
	}
