...
class Rugi_laba extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['judul'] = "Laporan Rugi Laba";
		$this->load->view('layout/header', $data);
		$this->load->view('laporan/rugi_laba/table', $data);
		$this->load->view('laporan/rugi_laba/modal', $data);
		$this->load->view('layout/footer', $data);
		$this->load->view('laporan/rugi_laba/script', $data);
	}
