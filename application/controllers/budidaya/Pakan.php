...
class Pakan extends CI_Controller
{
	...
	public function index()
	{
		$data['menu'] = "budidaya";
		$data['submenu'] = "pakan";
		$data['judul'] = "Budidaya Pakan";
		$this->load->view('layout/header', $data);
		$this->load->view('budidaya/pakan/table', $data);
		$this->load->view('budidaya/pakan/modal', $data);
		$this->load->view('layout/footer', $data);
		$this->load->view('budidaya/pakan/script', $data);
	}

	public function get_all()
	{
		$data = $this->pakan_model->list_data();
	...
	function get_data()
	{
		...
		$data = $this->pakan_model->get_data_by_id($kode);
		echo json_encode($data);
	}
	...
	{
		$data = $_POST;
		$this->pakan_model->save($data);
	}

	public function delete()
	{
		$id = $this->input->post('id');
		$data = $this->pakan_model->delete($id);
		echo json_encode($data);
	}
	...
	public function upload_ktp()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/pakan/ktp/";
	...
	public function upload_sertifikat()
	{
		if (isset($_POST) == true) {
			...
			//folder upload
			$targetDir = "assets/upload/pakan/sertifikat/";
			$targetFilePath = $targetDir . $namaFile;
