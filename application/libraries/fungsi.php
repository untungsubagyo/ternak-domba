...
function generate_barcode($sparepart_code, $barcode_type, $scale=6, $fontsize=18, $thickness=30,$dpi=72) {
...
function catat($kegiatan,$awal ='',$isData=false)
{
	...
	//catat ke log
	$this->CI->db->insert('web_catatan',array('ip'=>$ip,
	                                      'server'=>$ip_name,
	                                      'user'=>$creator,
	                                      'kegiatan'=>$str,
	                                      'waktu'=>$waktu));
