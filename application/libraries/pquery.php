...
class JQuery  {
	...
	function form_remote_tag($options)
	{
		...
		return '<form id="'.$options['id'].'" enctype=\'multipart/form-data\' action="'.$options['url'].'" onsubmit=\''.$this->remote_function($options).'; return false;\' method="'.(isset($options['type'])?$options['type']:'GET').'"  >';
