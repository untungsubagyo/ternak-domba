<!-- jQuery 2.2.0 -->
<script src="<?php echo base_url();?>assets/template/admin/plugins/jQuery/jQuery-2.2.0.min.js"></script>
<!-- Bootstrap 3.3.6 -->
<script src="<?php echo base_url();?>assets/template/admin/bootstrap/js/bootstrap.min.js"></script>
<!-- FastClick -->
<script src="<?php echo base_url();?>assets/template/admin/plugins/fastclick/fastclick.js"></script>
<!-- AdminLTE App -->
<script src="<?php echo base_url();?>assets/template/admin/dist/js/app.min.js"></script>
<!-- Sparkline -->
...
<!-- ChartJS 1.0.1 -->
<script src="<?php echo base_url();?>assets/template/admin/plugins/chartjs/Chart.min.js"></script>
<!-- AdminLTE dashboard demo (This is only for demo purposes) -->
<script src="<?php echo base_url();?>assets/template/admin/dist/js/pages/dashboard2.js"></script>
