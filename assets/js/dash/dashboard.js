var Dashboard = function() {
    ...
    return {
        ...
        initJvectormap: function() {

            jQuery.ajax({
                url: "dashboard/ajax?query_name=map",
                dataType: "json"
            }).done(function(data) {
                ...
                $('#world-map').vectorMap({
                    ...
                    series: {
                        regions: [{
                            values: data.map,
                            // values: anyData,
                            scale: ['#C8EEFF', '#50A3C8', '#0071A4'],
                            //scale: ['#DDDDDD', '#589CBB', '#0071A4'],
                            //scale: ['#DDDDDD', '#85B2C6', '#0071A4'],
                            //scale: ['#C8EFFF', '#a4e3ff', '#7dd7ff', '#2ebeff', '#009adf', '#0071A4', '#00567d'],
                            //scale: ['#C8EEFF', '#0071A4'],
                            // scale: ['#AEC6CF', '#FDFD96', '#77DD77'],
                            // scale: ['#FF6961', '#FDFD96', '#4CBB17'],
                            // scale: ['#FF6961', '#FDFD96', '#87CEEB'],
                            // scale: ['#FF6961', '#FDFD96', '#77DD77'],
                            // scale: ['#FFFFFF', '#FDFD96', '#77DD77'],
                            // scale: ['#FFFFFF', '#FDFD96', '#77DD77'],
                            // min: data.min,
                            // max: data.max,
                            min: 0,
                    ...
                    onRegionTipShow: function(e, el, code){
                        el.html(el.html()+' (Progress ' + data.map[code] + '%)');
                        //el.html(el.html()+' (Progress '+data.map[code]+'%)');
                    }
                });
                ...
                $('#world-map').vectorMap({
                    ...
                    series: {
                        regions: [{
                            // values: data.realisasipersatker,
                            values: data.map,
                            scale: ['#C8EEFF', '#0071A4'],
                            // scale: ['#C8EEFF', '#0071A4'],
                            // scale: ['#AEC6CF', '#FDFD96', '#77DD77'],
                    ...
                    onRegionTipShow: function(e, el, code){
                        el.html(el.html()+' (Realisasi '+ data.map[code] +'%)');
                    }
                });
                */
            ...
            $('#world-map').vectorMap({
              ...
              onRegionTipShow: function(e, el, code){
                // el.html(el.html()+' (Realisasi '+data.realisasipersatker[code]+'%)');
              }
            });
            */
        },
        ...
        initJQVMAP: function() {
            ...
            jQuery('#regional_stat_indonesia').click(function() {
                showMap("indonesia");
            });
        ...
        */
        ...
        initMorisCharts: function() {
            ...
            $("#pilih_stat :input").change(function() {
                // console.log(this); // points to the clicked input button
                // alert(this.value);
                // alert('Anda memilih chart ' + this.value);

                var dashboardMainChart;
                ...
                if (this.value == 'file') {
                    ...
                    jQuery.ajax ({
                        ...
                        url: "dashboard/ajax?query_name=sending",
                        dataType: "json"
                    ...
                    jQuery.ajax ({
                        ...
                        url: "dashboard/ajax?query_name=sending_data",
                        dataType: "json"
        ...
        initAmChart4: function() {
            ...
            jQuery.ajax({
                ...
                url: "/dashboard/ajax?query_name=rkr_nasional",
                dataType: "json"
                ...
                var data = [{
                    ...
                    "kerusakan": "Rusak Sedang",
                    "persen": 65
                }, {
                    "kerusakan": "Rusak Berat",
                    "persen": 39
                }, {
                    "kerusakan": "Rusak Total",
                    "persen": 19
                }];
                */
        ...
        initLogin: function() {
            $('#submitLogin').on( "submit", function( event ) {
                var self = $(this);
                event.preventDefault();
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if(data.success){
                            self.parent('li').html('<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">'+
                            '<span class="username username-hide-mobile">Login as '+data.username+'</span></a>'+
                            '<ul class="dropdown-menu dropdown-menu-default">'+
                            '<li><a href="/logout"><i class="icon-key"></i> Log Out </a></li></ul>')
                        }else{
                            $('.warning-msg').text("Username atau password salah");
